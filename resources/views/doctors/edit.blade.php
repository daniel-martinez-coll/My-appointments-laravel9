        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex align-items-center">
                    <p class="mb-0">Modificar Doctor</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="name" type="text" value="{{old('name', $doctor->name) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="dni" type="text" value="{{old('dni', $doctor->dni) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                              <label for="example-text-input" class="form-control-label">Nombre</label>
                              <input class="form-control" type="text" name="firstName" type="text" value="{{old('firstName', $doctor->firstName) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                              <label for="example-text-input" class="form-control-label">Apellido</label>
                              <input class="form-control" type="text" name="lastName" type="text" value="{{old('lastName', $doctor->lastName) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="address" type="text" value="{{old('address', $doctor->address) }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Teléfono</label>
                            <input class="form-control" type="text" name="phone" type="text" value="{{old('phone', $doctor->phone) }}">
                          </div>
                      </div>
                        <div class="col-md-4">
                            <div class="form-group">
                              <label for="example-text-input" class="form-control-label">Provincia</label>
                              <input class="form-control" type="text" name="city" type="text" value="{{old('city', $doctor->city) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                              <label for="example-text-input" class="form-control-label">País</label>
                              <input class="form-control" type="text" name="country" type="text" value="{{old('country', $doctor->country) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                              <label for="example-text-input" class="form-control-label">Código Postal</label>
                              <input class="form-control" type="text" name="postalCode" type="text" value="{{old('postalCode', $doctor->postalCode) }}">
                            </div>
                        </div>
                    </div>
                    <hr class="horizontal dark">
